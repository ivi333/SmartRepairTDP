...
INSERT INTO "Taller" ("ID", "Cif", "adreça", capacitat, "capTaller", telefon, web, actiu, "dataApertura", "dataModificacio", "dataBaixa") VALUES (1, 'B11111111', 'C/Nort, 3 - 07760 - Ciutadella', 30, NULL, '971385175', 'www.taller1.com', true, '2013-04-11', NULL, NULL);

INSERT INTO "Taller" ("ID", "Cif", "adreça", capacitat, "capTaller", telefon, web, actiu, "dataApertura", "dataModificacio", "dataBaixa") VALUES (2, 'B22222221', 'C/Sud, 6 - 07750 - Ferreries', 25, NULL, '971155175', 'www.taller2.com', true, '2013-04-12', NULL, NULL);

INSERT INTO "Taller" ("ID", "Cif", "adreça", capacitat, "capTaller", telefon, web, actiu, "dataApertura", "dataModificacio", "dataBaixa") VALUES (3, 'B33333333', 'C/Est, 9 - 07740 - Es Mercadal', 20, NULL, '971375175', 'www.taller3.com', true, '2013-04-13', NULL, NULL);

INSERT INTO "Taller" ("ID", "Cif", "adreça", capacitat, "capTaller", telefon, web, actiu, "dataApertura", "dataModificacio", "dataBaixa") VALUES (4, 'B44444444', 'C/Oest, 12 - 07730 - Alaior', 15, NULL, '971335175', 'www.taller4.com', true, '2013-04-14', NULL, NULL);

INSERT INTO "Taller" ("ID", "Cif", "adreça", capacitat, "capTaller", telefon, web, actiu, "dataApertura", "dataModificacio", "dataBaixa") VALUES (5, 'B55555555', 'C/Tramontana, 15 - 07701 - MaÛ', 40, NULL, '971355175', 'www.taller5.com', true, '2013-04-15', NULL, NULL);
...
INSERT INTO "Asseguradora" ("IdAsseguradora", "CIF", nom, "adreça", telefon) VALUES (1, 'B12345678', 'MUTUA MADRILEÑA', 'Avda. Castellana 39', 912345678);
...
INSERT INTO "Client" (nom, cognoms, "adreça", nif, poblacio, "codiPostal", "numClient", "dataAlta") VALUES ('Joan           ', 'Terradell Vidal                    ', 'Plaça Major, 23 2º

2ª                             ', '12465857 ', 'Barcelona                               ', 8014, 23654, '1995-02-20');

INSERT INTO "Client" (nom, cognoms, "adreça", nif, poblacio, "codiPostal", "numClient", "dataAlta") VALUES ('Ferran         ', 'Pons Margelí                       ', 'Carrer Constitució, 4 1º

2ª                       ', '71226575 ', 'Barcelona                               ', 8016, 24154, '1999-06-12');

INSERT INTO "Client" (nom, cognoms, "adreça", nif, poblacio, "codiPostal", "numClient", "dataAlta") VALUES ('Jose Fina      ', 'Pérez Manga                        ', 'Carrer del Arbres, 99

7º                          ', '21548789 ', 'Badalona                                ', 8912, 24250, '2000-10-10');

INSERT INTO "Client" (nom, cognoms, "adreça", nif, poblacio, "codiPostal", "numClient", "dataAlta") VALUES ('José Antonio   ', 'Fernández Fernández                ', 'Carrer Pelai, 33

1º 2ª                            ', '65235265 ', 'Badalona                                ', 8910, 24255, '2000-10-11');

INSERT INTO "Client" (nom, cognoms, "adreça", nif, poblacio, "codiPostal", "numClient", "dataAlta") VALUES ('Susana         ', 'GÛmez H‰nse                        ', 'Carrer Muntaner, 157 5º

2º                        ', '45547465 ', 'Barcelona                               ', 8016, 242655, '2000-11-11');

INSERT INTO "Client" (nom, cognoms, "adreça", nif, poblacio, "codiPostal", "numClient", "dataAlta") VALUES ('Juan Antonio   ', 'Segura Nicol·s                     ', 'Carrer Tier, 13
...
INSERT INTO "Vehicle" (marca, tipus, num_chasis, model, matricula, color, "any", "numReparacio") VALUES ('Renault        ', 'berlina        ', '123456789           ', 'Megane         ', '123456  ', 'negre     ', '2006-01-01', 1);

INSERT INTO "Vehicle" (marca, tipus, num_chasis, model, matricula, color, "any", "numReparacio") VALUES ('BMW            ', 'c              ', '123456777           ', '320            ', '654321  ', 'blau      ', '2010-01-01', 2);
